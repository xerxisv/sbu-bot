...
if os.getenv('MODE') == 'PRODUCTION':
    ...
    BRIDGE_CHANNEL_IDS = [812416103372292126, 819929855008178246, 832346801876107365,
                          837142928957898812, 843467314259296276, 879873118993252352]
    BRIDGE_BOT_IDS = [941170588611928065, 941170102173311016, 941170178736140310,
                      941169937425268736, 941170256783740948, 1021642157494382622]
